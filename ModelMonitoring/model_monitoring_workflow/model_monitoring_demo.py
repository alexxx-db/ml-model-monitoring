...
# MAGIC %md
# MAGIC 
# MAGIC ## Model Monitoring Quickstart 
# MAGIC 
...
username_prefix = dbutils.notebook.entry_point.getDbutils().notebook().getContext().tags().apply("user").split(".")[0]

dbutils.widgets.text("monitor_name", f"{username_prefix}_airbnb_monitor")
dbutils.widgets.text("monitor_db", f"{username_prefix}_airbnb_monitor_db")
dbutils.widgets.text("model_name", f"{username_prefix}_airbnb_rf")
